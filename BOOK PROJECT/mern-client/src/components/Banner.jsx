    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
            ...
            <div className='md:w-1/2 space-y-8 h-full'>
                ...
                <p className='md:w-4/5'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum, sunt! Ab similique ipsam illum cum reiciendis enim dolorum nobis vel.</p>
                ...
                <button className='bg-blue-700 px-6 py-2 text-white font-medium hover:bg-black
                 transition-all ease-in-200'>Search</button>
            </div>
            </div>
